...
class SomeCategoryWidget extends StatelessWidget {
  final route = MaterialPageRoute(builder: (context) => SomeCategoryWidget());

  Future fetchData(category) async {
    Response response;
    //in the main shared file add the basepoint - then only increment the string when you call different endpoints
    var basePoint = 'https://newsapi.org/v2/';
    response = await dio.get(
        'https://newsapi.org/v2/top-headlines?category=$category&language=en&apiKey=1bd9ed90ffb4460ca9cb10df1f19fac2');
  ...
  Widget build(BuildContext context) {
    // var icon = context.read<TestCubit>().icon;
    ...
    final category = context.read<TestCubit>().getSelectedCategory();
